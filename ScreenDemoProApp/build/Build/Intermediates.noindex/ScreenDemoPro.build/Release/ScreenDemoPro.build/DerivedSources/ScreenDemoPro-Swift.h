...
#ifndef SCREENDEMOPRO_SWIFT_H
#define SCREENDEMOPRO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScreenDemoPro",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13ScreenDemoPro11AppDelegate")
...
@class NSCoder;
@class NSEvent;
SWIFT_CLASS("_TtC13ScreenDemoPro10CanvasView")
...
SWIFT_CLASS("_TtC13ScreenDemoPro12CanvasWindow")
@interface CanvasWindow : NSPanel
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC13ScreenDemoPro22ShortcutRecorderNSView")
